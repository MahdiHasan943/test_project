      ...
      >
        <motion.div className="container mx-auto tablet:px-4 bg-[#f5faff] font-sans leading-normal tracking-normal">
          <Tab.Group selectedIndex={selectedIndex} onChange={handleTabChange}>
            <Tab.List className="flex justify-between  tablet:justify-center  tablet:px-0  h-[90px] max-w-[800px] mx-auto  gap-2 tablet:gap-8 items-center tablet:space-x-1  rounded-xl  ">
              <Tab
                className={({ selected }) =>
                  selected
                    ? " bg-[#000]  outline-none relative overflow-hidden group text-[15px] tablet:text-[16px]  py-4 px-5 font-bold text-[#fec63f] border border-[2] outline outline-2 outline-[#ffffff] rounded-md shadow-xl"
                    : "text-[#fff] bg-[#fec63f] overflow-hidden  group relative outline-none text-[11px] tablet:text-[16px] py-4 px-5 font-bold border border-l-0 border-t-0 border-b-0 border-r-2"
                }
              >
                <div className="h-full w-full bg-[#000] z-0 flex justify-center items-center duration-300 delay-75 ease-linear translate-x-[-100%] group-hover:translate-x-[-0%] absolute  top-0 left-0">
                  {" "}
                  {t("DailyTrends")}
                </div>{" "}
                {t("DailyTrends")}
              ...
              <Tab
                className={({ selected }) =>
                  selected
                    ? "bg-[#000]  relative overflow-hidden group  outline-none text-[15px] tablet:text-[16px] py-4 px-5 font-bold text-[#fec63f] border border-[2] outline outline-2 outline-[#ffffff] rounded-md shadow-xl"
                    : "text-[#fff] relative overflow-hidden group  bg-[#fec63f] outline-none text-[11px] tablet:text-[16px] py-4 px-5 font-bold border border-l-0 border-t-0 border-b-0 border-r-2"
                }
              >
                <div className="h-full w-full bg-[#000] z-0 flex justify-center items-center duration-300 delay-75 ease-linear translate-x-[-100%] group-hover:translate-x-[-0%] absolute  top-0 left-0">
                  {" "}
              ...
              <Tab
                className={({ selected }) =>
                  selected
                    ? "bg-[#000] relative overflow-hidden group  outline-none text-[15px] tablet:text-[16px] py-4 px-5 font-bold text-[#fec63f] border border-[2] outline outline-2 outline-[#ffffff] rounded-md shadow-xl"
                    : "text-[#fff] relative overflow-hidden group  bg-[#fec63f] outline-none text-[11px] tablet:text-[16px] py-4 px-5 font-bold 2"
                }
              >
                <div className="h-full w-full bg-[#000] z-0 flex justify-center items-center duration-300 delay-75 ease-linear translate-x-[-100%] group-hover:translate-x-[-0%] absolute  top-0 left-0">
                  {" "}
            ...
            <Tab.Panels className="mt-2">
              {}
              <Tab.Panel className="bg-[#f5faff] p-3 rounded-xl">
                ...
                <div className="shadow-md max-w-[550px] mx-auto rounded px-8 pt-6 pb-8 mb-4">
                  ...
                  <div className="flex gap-2 items-center">
                    ...
                    />
                    <select
                      className="shadow border rounded w-full  py-4 px-4 text-gray-700 leading-tight focus:outline-none focus:shadow-outline "
                      id="geoInput"
                      value={geo}
                  ...
                  <div className={`  mx-auto text-center py-6`}>
                    {user ? (
                      <Button
                        className={
                          "w-[280px] h-[60px] mx-auto  mt-12 group tablet:mx-0 tablet:w-full"
                          // border-l-[4px] border-[#dcac3a] ease-linear delay-200 hover:border-0
                        }
                      >
                        <button
                          className={`${plexmono.className}   w-[280px] h-[60px] tablet:w-full  mt-p text-[#111] group-hover:text-[#fff] text-[15px]  absolute top-1/2 left-1/1 transform  -translate-y-1/2`}
                          onClick={() => {
                            fetchDailyTrends();
                          }}
                        >
                      ...
                      <>
                        ...
                        >
                          <SignInButton>
                            <button
                              className={`${plexmono.className}  w-[280px] h-[60px] tablet:w-full  mt-p text-[#111] group-hover:text-[#fff] text-[16px]  absolute top-1/2 left-1/1 transform  -translate-y-1/2`}
                            >
                ...
                {user ? (
                  <>
                    <div className="bg-white rounded px-8 pt-20 pb-8 mb-8">
                      {isLoading ? (
                        <div>Loading...</div>
                      ) : (
                        <>
                          ...
                          <div className="grid pb-16 pt-4 grid-cols-1 max-w-[1000px] mx-auto desktop:grid-cols-3 gap-4">
                            {dailyTrendsResults.map((item, index) => (
                              <div
                                key={index}
                                className={`${work_sans.className} bg-white max-w-[280px] py-6 tablet:w-full shadow-md rounded overflow-hidden`}
                              >
                                                ...
                                                >
                                                  <Dialog.Panel className="w-full min-h-[700px] max-w-[800px] transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                                                    ...
                                                    <div className="mt-2">
                                                      ...
                                                      <p className="text-[18px] py-4 flex items-center gap-4 tablet:gap-10">
                                                        Traffic: {item.traffic}{" "}
                                                        users
                                                        <span>
                                                          Time:{" "}
              ...
              <Tab.Panel className="bg-[#f5faff]  p-3 rounded-xl">
                ...
                >
                  <div className="max-w-[550px] mx-auto">
                    ...
                    <div className="shadow-md p-2 sm:p-5">
                      <div className="mb-4 ">
                        <label
                          htmlFor="query"
                        ...
                        <input
                          ...
                          id="query"
                          name="q"
                          className="mt-1 px-4 py-4 border shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md"
                  ...
                  {user ? (
                    <div
                      className="max-w-[1000px] mx-auto py-20 grid grid-cols-1 tablet:grid-cols-3 gap-4"
              ...
              <Tab.Panel className="bg-[#f5faff]  p-3 rounded-md">
                ...
                {user ? (
                  <div className="">
                    {interestResults.length === 0 && (
                      <div className="w-full pt-16  max-w-[1400px] mx-auto grid grid-cols-1 tablet:grid-cols-2 gap-8 overflow-hidden">
                        <div className="">
                          <img
                    ...
                    {interestResults.length > 0 && (
                      <div className="pt-16 chart-container">
                        <h3>
                          {" "}
